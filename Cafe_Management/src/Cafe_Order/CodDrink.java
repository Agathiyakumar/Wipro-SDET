...
public class CodDrink {
    public static void registerDrink(Scanner sc) {
        try (Connection con = DBConnection.getConnection()) {
            ...
            String sql = "INSERT INTO ColdDrinks (ItemName, Quantity, Size, TableNo) VALUES (?, ?, ?, ?)";
            ...
            String sql1 = "SELECT * FROM ColdDrinks";
...
//        try (Connection con = DBConnection.getConnection()) {
//            String sql = "SELECT * FROM ColdDrinks";
//            Statement stmt = con.createStatement();
