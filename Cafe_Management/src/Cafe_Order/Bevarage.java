...
public class Bevarage {
    public static void registerBeaver(Scanner sc) {
        try (Connection con = DBConnection.getConnection()) {
            ...
            String sql = "INSERT INTO Bevarage (ItemName, Quantity, Size, TableNo) VALUES (?, ?, ?, ?)";
            ...
            String sql1 = "SELECT * FROM Bevarage";
...
//        try (Connection con = DBConnection.getConnection()) {
//            String sql = "SELECT * FROM Bevarage";
//            Statement stmt = con.createStatement();
